...
class TestQRVerification(TransactionCase):
    ...
    def test_qr_code_generation(self):
        ...
        self.payment._compute_payment_qr_code()
    ...
    def test_qr_disabled_when_flag_false(self):
        """Test QR is not generated when disabled"""
        self.payment.qr_in_report = False
        self.payment._compute_payment_qr_code()
        
        self.assertFalse(self.payment.qr_code, "QR code should not be generated when disabled")
